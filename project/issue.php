        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <form method="POST" action="">
            ...
            <div class="form-group text-center">
              <button type="submit" name="submit" class="btn btn-primary"><strong>Issue</strong></button>
            </div>
          </form>
          <?php
if(isset($_POST["submit"])){
    ...
    if($book["status"]=='Available'){
        ...
        if($user["status"]=='Clear'){
            $un=$user["name"];
            mysqli_query($link,"update books set status='Issued' where id=$_POST[bookid]");
            mysqli_query($link,"update registration set status='Hold' where id=$_POST[userid]");
            $d=date("d-m-Y");
            $res3=mysqli_query($link,"insert into record values('','$_POST[userid]','$_POST[bookid]','$un','$bn','$d','')");
            if($res3){
              ?>
              ...
              <strong style="color:white">Issue Failed</strong>
                   </div>
              <?php
            }
        }
          ...
          ?>
          <div class="alert alert-danger text-center">
      <strong style="color:white">User has Already been of Hold</strong>
           </div>
           <?php
        }
      }
        ...
        ?>
      <div class="alert alert-danger text-center">
      <strong style="color:white">User Not Found</strong>
           </div>
       <?php
      }
    }
      ...
      ?>
      <div class="alert alert-danger text-center">
      <strong style="color:white">Book already Issued</strong>
           </div>
       <?php
    }
    }
      ...
      ?>
      <div class="alert alert-danger text-center">
      <strong style="color:white">Book Not Found</strong>
           </div>
      <?php
    }
}
